...
## AnyKernel setup
# EDIFY properties
kernel.string=BeyondStock-Hima by Captain_Throwback
do.devicecheck=1
do.initd=1
do.modules=0
do.cleanup=1
device.name1=htc_himawhl
device.name2=htc_himawl
device.name3=htc_himaul
device.name4=htc_himauhl
device.name5=htc_hima
...
insert_line init.qcom.rc "/storage/sdcard1" after "symlink /storage/ext_sd /sdcard2" "    symlink /storage/ext_sd /storage/sdcard1
";

# init.htc_hima.rc
backup_file init.htc_hima.rc;
remove_line init.htc_hima.rc "start hrdump";
